...
<Navbar fluid class="md:px-28 px-4">
	...
	<NavUl class=" order-2 font-['Inter']">
		...
		<NavLi href="#popularMenue" id="anime" class={`text-lg dark:text-white ${activeSection === 'popularMenue' ? 'active' : ''}`}>Menu populaire</NavLi>
		<NavLi href="#menu" id="anime" class={`text-lg dark:text-white ${activeSection === 'menu' ? 'active' : ''}`}>Menu</NavLi>
		<NavLi href="#order" id="anime" class={`text-lg dark:text-white ${activeSection === 'order' ? 'active' : ''}`}>Commander</NavLi>
		<NavLi href="#blog" id="anime" class={`text-lg dark:text-white ${activeSection === 'panier' ? 'active' : ''}`}>Blog</NavLi>
       ...
       <div class='order-1'>
		 <a href="/" class="flex items-center gap-2"> 
			...
			<span class='capitalize text-2xl font-bold text-blue-950 dark:text-white'>food</span>
		</a>
	   </div>
